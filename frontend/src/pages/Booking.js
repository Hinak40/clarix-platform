  ...
  return (
    <div style={{ backgroundColor: bg }}>
      ...
      <section className="section-pad" style={{ background: 'linear-gradient(135deg, #080c14 0%, #0f172a 50%, #1a1040 100%)', padding: '120px 80px 80px', textAlign: 'center' }}>
        ...
        <h1 className="section-title" style={{ fontSize: '56px', fontWeight: '800', color: 'white', marginBottom: '20px', letterSpacing: '-1.5px' }}>Schedule a Free Call</h1>
        <p className="section-subtitle" style={{ fontSize: '18px', color: '#64748b' }}>Let's discuss your project and how we can help.</p>
      </section>
      ...
      <section className="section-pad" style={{ padding: '100px 80px', backgroundColor: bg }}>
        <div className="contact-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.4fr', gap: '50px', alignItems: 'start' }}>
          <div>
            <h2 style={{ fontSize: '28px', fontWeight: '800', color: titleColor, marginBottom: '15px' }}>What to Expect</h2>
            ...
            {[
              ...
              <div key={i} style={{ display: 'flex', gap: '14px', alignItems: 'flex-start', marginBottom: '14px', backgroundColor: cardBg, padding: '16px', borderRadius: '12px', border: `1px solid ${border}` }}>
          ...
          <div style={{ backgroundColor: cardBg, padding: '35px', borderRadius: '20px', border: `1px solid ${border}` }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: '14px' }}>
                ...
                <div className="time-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px' }}>
                  {timeSlots.map((slot) => (
